...
curl "https://www.berlin.de/lageso/gesundheit/infektionskrankheiten/corona/tabelle-altersgruppen-gesamtuebersicht/index.php/index/all.csv?q=" -o "${DIR}7-day-incidence.csv"
